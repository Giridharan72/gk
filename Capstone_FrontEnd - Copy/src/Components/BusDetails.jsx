...
//   const bus = location.state?.bus || {}; // Get bus details from state
...
//     alert(`Booking confirmed for ${numPassengers} passenger(s) in seats: ${selectedSeats.join(', ')}`);
//   };

//   return (
//     <div className="container">
//       <h2 className="my-4">Bus Details - {bus.busName}</h2>
...
//           {[...Array(bus.capacity).keys()].map(seat => (
//             <button
//               key={seat}
...
//         </>
//       ) : (
//         <div>No bus details available</div>
//       )}
//     </div>
//   );
// };
